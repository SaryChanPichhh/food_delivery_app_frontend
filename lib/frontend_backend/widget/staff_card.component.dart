...
class StaffCardComponent extends StatelessWidget {
  final StaffModel staff;
  const StaffCardComponent({super.key, required this.staff});

  @override
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () => Get.toNamed(AppRoutes.adminStaffDetail, arguments: staff),
